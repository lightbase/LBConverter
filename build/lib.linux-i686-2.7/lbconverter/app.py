...
# import subprocess
import time
# from LBConverter import logger
...
def main(domain,outpath):
    ...
    # logger.info("Script iniciado em " + inicio)
    ...
    # logger.info("Script finalizado em " + fim)


logger = logging.getLogger("LBConverter")

# main('http://neo.lightbase.cc/')

# timeronff = time.time()
# tempo = (timeronff - timeron)
# tempo = str(tempo)
# print 'Esse script gastou ' + tempo + ' segundos'
